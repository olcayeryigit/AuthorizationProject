...
//A)loginin görevi, payload ile gönderilen username ve passwordu Api ye göndermektir, yani api bağlantısı sağlanır
...
export const login = async (payload) => {
  ...
  if (!res.ok) throw new Error(data.message); /*eğer hata varsa, apiden dönen mesajı js hatası olarak fırlat deriz*/
  return data;
};
